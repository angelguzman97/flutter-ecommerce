      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            ref.read(productFormProvider(productState.product!)
            .notifier).onFormSubmit().then((value){
              if(!value) return;
      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField(
            ...
            onChanged: (value) => 
            ref.read(productFormProvider(product).notifier).onTitleChanged(value),
          ...
          CustomProductField(
            ...
            onChanged: (value) => 
            ref.read(productFormProvider(product).notifier).onSlugChanged(value),
          ...
          onGendersChanged: ref.read(productFormProvider(product).notifier).onGenderChanged,),
          const SizedBox(height: 15),
          ...
          CustomProductField(
            ...
            onChanged: (value) => 
            ref.read(productFormProvider(product).notifier).onDescriptionChanged(value),
          ),
          CustomProductField(
            isBottomField: true,
            maxLines: 2,
            ...
            onChanged: (value) => ref.read(productFormProvider(product).notifier).onTagsChanged(value),
          ),
    ...
    return PageView(
      ...
      children: images.map((image) {
        ...
        if( image.startsWith('http')){
          ...
          imageProvider = FileImage(File(image)); //Reconstruye la foto de la url
